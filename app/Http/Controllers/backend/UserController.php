...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($message) {
            ...
            return redirect()->route('user.register')->with('success_message', 'You are successfully registered. Please proceed to the Login Page.');
        } else {
            return redirect()->route('user.register')->with('error_message', 'Registration Failed ');
        }
    }
